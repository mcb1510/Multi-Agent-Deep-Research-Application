...
async def run_gradio(query: str):
...
with gr.Blocks(title="Deep Research") as ui:
    ...
    run_button.click(run_gradio, inputs=query_textbox, outputs=report)
    query_textbox.submit(run_gradio, inputs=query_textbox, outputs=report)
